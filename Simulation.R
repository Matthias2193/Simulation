...
temp_df <- bi_result_df4
t(matrix(c(mean(temp_df$original_1), mean(temp_df$rounded_1), mean(temp_df$bias_1),
         mean(temp_df$original_2), mean(temp_df$rounded_2), mean(temp_df$bias_2)), ncol = 2))
